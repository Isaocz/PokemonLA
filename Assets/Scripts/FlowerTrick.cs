...
public class FlowerTrick : FollowBaby
{
    // Start is called before the first frame update
    Vector3 MoveDir;
    FlowerTrickCollider Colision;
    GameObject Shadow01;
    GameObject Shadow02;
    bool isDieEventDone;
    ...
    void Start()
    {
        ...
        Colision = transform.GetChild(0).GetComponent<FlowerTrickCollider>();
    ...
    void Update()
    {
        ...
        switch (NowState)
        {
            case State.Move:
                ...
                Colision.transform.position += Time.deltaTime * 6.0f * MoveDir;
                Shadow01.transform.position += Time.deltaTime * 6.0f * MoveDir;
                Shadow02.transform.position += Time.deltaTime * 6.0f * MoveDir;
                break;
            case State.Return:
            ...
            case State.Blast:
                ...
                if (!isDieEventDone)
                {
                    ...
                    Timer.Start(this, 1.2f, () =>
                    {
                        NowState = State.Die;
                        Colision.transform.localPosition = Vector3.zero;
                        Shadow01.transform.localPosition = new Vector3(0, -1.027f, 0);
                        Shadow02.transform.localPosition = new Vector3(0, -0.9802998f, 0);
    ...
    public void Blast()
    {
        ...
        FlowerTrickBlaset p = BlastObj.transform.GetChild(0).GetComponent<FlowerTrickBlaset>();
        p.player = player;
