...
public class CrystalOnix : Empty
{
    ...
    CrystalOnixBodyShadow OnixBodyTop;
    ...
    public CrysatalOnixHeadBeam HeadBeam;
    bool isDig01Done;
    bool isDig02Done;
    bool isDig03Done;
    bool isHeadBeamDone;
    ...
    public CrysatalOnixSandTomb SandTombLarge;
    public CrysatalOnixSandTomb SandTombSmall;
    ...
    void Start()
    {
        ...
        {
            SubEmptyBodyList.Add(transform.GetChild(3).GetChild(0).GetChild(i).GetComponent<CrystalOnixBodyShadow>());
        ...
        OnixBodyTop = SubEmptyBodyList[0].GetComponent<CrystalOnixBodyShadow>();
        for (int i = 0; i < SubEmptyBodyList.Count; i++)
        {
            for (int j = i + 1; j < SubEmptyBodyList.Count; j++)
            {
                Physics2D.IgnoreCollision(SubEmptyBodyList[i].GetComponent<CrystalOnixBodyShadow>().BodyCollider2D, SubEmptyBodyList[j].GetComponent<CrystalOnixBodyShadow>().BodyCollider2D);
            }
        }
                ...
                switch (NowState)
                {
                    ...
                    case State.MoveOutWallState:
                        ...
                        if (!isDig01Done && MoveOutTimer >= 1.8f)
                        {
                            isDig01Done = true;
                            if (!isFearDone) {
                                OnixTailDig d = Instantiate(TaigDig, TargetPosition - Vector3.down * 0.05f + (!isEmptyConfusionDone ? Vector3.zero : new Vector3(Random.Range(-1.0f, 1.0f), Random.Range(-1.0f, 1.0f), 0).normalized * 1.5f), Quaternion.identity); 
                                d.ParentOnix = this;
                                if (isAngry)
                                {
                                    Timer.Start(this, 0.0f, () => { Instantiate(SandTombSmall, d.transform.position, Quaternion.identity); });
                                }
                            }
                        }
                        ...
                        if (!isHeadBeamDone && MoveOutTimer >= 7.2f)
                        {
                            isHeadBeamDone = true;
                            if (!isFearDone)
                            {
                                CrysatalOnixHeadBeam hb = Instantiate(HeadBeam, TargetPosition - Vector3.down * 0.05f + (!isEmptyConfusionDone ? Vector3.zero : new Vector3(Random.Range(-1.0f, 1.0f), Random.Range(-1.0f, 1.0f), 0).normalized * 1.5f), Quaternion.identity);
                                hb.ParentCrystalOnix = this;

                                if ((player.transform.position - ParentRoom.transform.position).x < 0)
                                {
                                    hb.LookX = -1;
                                    if (isAngry)
                                    {
                                        Instantiate(SandTombLarge, transform.parent.position + Vector3.right * 8.0f, Quaternion.identity);
                                        OnixRockTomb r1 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.up * 2, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r1.isStealthRock = true; r1.ParentOnix = this;
                                        OnixRockTomb r2 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.right * 2, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r2.isStealthRock = true; r2.ParentOnix = this;
                                        OnixRockTomb r3 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.left * 2, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r3.isStealthRock = true; r3.ParentOnix = this;
                                        OnixRockTomb r4 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.down * 2, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r4.isStealthRock = true; r4.ParentOnix = this;
                                        OnixRockTomb r5 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.up * 1.6f + Vector3.right * 1.6f, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r5.isStealthRock = true; r5.ParentOnix = this;
                                        OnixRockTomb r6 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.right * 1.6f + Vector3.down * 1.6f, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r6.isStealthRock = true; r6.ParentOnix = this;
                                        OnixRockTomb r7 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.left * 1.6f + Vector3.up * 1.6f, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r7.isStealthRock = true; r7.ParentOnix = this;
                                        OnixRockTomb r8 = Instantiate(RockTomb, transform.parent.position + Vector3.right * 8.0f + Vector3.down * 1.6f + Vector3.left * 1.6f, Quaternion.identity, ParentRoom.transform.GetChild(2));
                                        r8.isStealthRock = true; r8.ParentOnix = this;
                                    }
                                }
                                else
                                {
                        ...
                        if (MoveOutTimer >= 18.5f)
                        {
                            ...
                            if (isAllBodyMoveOut)
                            {
                                ...
                                isDig01Done = false; isDig02Done = false; isDig03Done = false; isHeadBeamDone = false;
                                foreach (CrystalOnixBodyShadow b in SubEmptyBodyList)
                                {
    ...
    void MoveInWall()
    {
        ...
        {
            case 0:
                DigOutEffect = Instantiate(OnixBodyTop.GetComponent<CrystalOnixBodyShadow>().DigEffect, transform.parent.position + MoveOutPosition[r], Quaternion.identity);
            ...
            case 4:
                DigOutEffect = Instantiate(OnixBodyTop.GetComponent<CrystalOnixBodyShadow>().DigEffect, transform.parent.position + MoveOutPosition[r], Quaternion.Euler(0, 0, 180));
            ...
            case 8:
                DigOutEffect = Instantiate(OnixBodyTop.GetComponent<CrystalOnixBodyShadow>().DigEffect, transform.parent.position + MoveOutPosition[r], Quaternion.Euler(0, 0, 90));
        ...
        if (!isRockTombCD && !isFearDone)
        {
            ...
            if (!isEmptyConfusionDone)
            {
                ...
                while (count != 0)
                {
                    ...
                    FallPosition = (Vector3)TargetPosition + (new Vector3(Random.Range(-1.0f, 1.0f), Random.Range(-1.0f, 1.0f), 0).normalized) * Random.Range(0.0f, 3.6f);
                    int TPCount = 0;
