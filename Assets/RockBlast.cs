...
public class RockBlast : Skill
{
    ...
    void Start()
    {
        ...
        Rock4 = transform.GetChild(3).GetComponent<RockBlastRock>();
        Rock5 = transform.GetChild(4).GetComponent<RockBlastRock>();
        ...
        switch (Count) 
        {
            ...
            case 4:
                ...
                Rock3.gameObject.SetActive(true);
                Rock4.player = player;
                Rock4.StartPostion = StartPosition4;
                Rock4.direction = direction4;
                Rock4.gameObject.SetActive(true);
                break;
            case 5:
                direction1 = (transform.rotation * Vector2.right).normalized;
                ...
                Rock4.gameObject.SetActive(true);
                Rock5.player = player;
                Rock5.StartPostion = StartPosition5;
                Rock5.direction = direction5;
                Rock5.gameObject.SetActive(true);
                break;
        }
        ...
        Rock4.SkillFrom = SkillFrom;
        Rock5.SkillFrom = SkillFrom;
    }
