    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if ( other.tag == ("Room") || other.tag == ("Player") || (empty.isEmptyInfatuationDone && other.gameObject != empty.gameObject && other.tag == ("Empty")))
        {
            ...
            if (other.tag == ("Player") && !empty.isEmptyInfatuationDone)
            {
                ...
                Pokemon.PokemonHpChange(empty.gameObject, other.gameObject, Dmage, 0, 0, Type.TypeEnum.Electric);
            ...
            if (other.tag == ("Empty") && empty.isEmptyInfatuationDone)
            {
                ...
                Pokemon.PokemonHpChange(empty.gameObject, e.gameObject, Dmage, 0, 0, Type.TypeEnum.Electric);
                if (Random.Range(0.0f, 1.0f) > 0.8f) { e.EmptyParalysisDone(1f , 5); }
