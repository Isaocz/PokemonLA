            ...
            && virtualCamera != null)
        {
            ...
            switch (state)
            {
                ...
                case TownMap.TownPlayerState.inWoodenHouse:
                    ...
                    break;
                case TownMap.TownPlayerState.inSkillMaker:
                    confiner.m_BoundingShape2D = PolygonColliderList[3];
                    cameraBounds = PolygonColliderList[3].gameObject;
                    break;
                case TownMap.TownPlayerState.inDayCareF1:
                    confiner.m_BoundingShape2D = PolygonColliderList[4];
                    cameraBounds = PolygonColliderList[4].gameObject;
                    break;
                case TownMap.TownPlayerState.inDayCareF2:
                ...
                case TownMap.TownPlayerState.inItemShop:
                    ...
                    break;
                case TownMap.TownPlayerState.inBossClub:
                    confiner.m_BoundingShape2D = PolygonColliderList[7];
                    cameraBounds = PolygonColliderList[7].gameObject;
                    break;
                case TownMap.TownPlayerState.inPoliceStation:
                    confiner.m_BoundingShape2D = PolygonColliderList[8];
                    cameraBounds = PolygonColliderList[8].gameObject;
                    break;
                case TownMap.TownPlayerState.inRockClub:
                    confiner.m_BoundingShape2D = PolygonColliderList[9];
                    cameraBounds = PolygonColliderList[9].gameObject;
                    break;
            }
